# Generated by Django 2.2.10 on 2021-07-13 11:37
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[('', 'Choose country...'), ('AF', 'Afghanistan'), ('AX', 'Åland Islands'), ('AL', 'Albania'),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(choices=[('y', 'Yes'), ('n', 'No'), ('r', 'Prefer not to tell')], default='',
                                   max_length=1,
                                   verbose_name='Do you belong to a national or ethnic minority, are you a migrant, a person of foreign origin?'),
        ),
    ]
