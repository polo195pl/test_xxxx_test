# Generated by Django 2.2.10 on 2021-07-13 10:42
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[('', 'Choose country...'), ('AD', 'Andorra'), ('AE', 'United Arab Emirates'),
                         ...
                         ('KM', 'Comoros'), ('KR', 'Korea, Republic of'), ('KW', 'Kuwait'), ('KY', 'Cayman Islands'),
                         ...
                         ('ML', 'Mali'), ('MN', 'Mongolia'), ('MM', 'Myanmar'), ('MO', 'Macau'),
                         ('MP', 'Northern Mariana Islands'), ('MQ', 'Martinique'), ('MR', 'Mauritania'),
                         ('MS', 'Monserrat'), ('MT', 'Malta'), ('MU', 'Mauritius'), ('MV', 'Maldives'),
                         ...
                         ('VI', 'United States Virgin Islands'), ('VN', 'Viet Nam'), ('VU', 'Vanuatu'),
                         ('WF', 'Wallis & Futuna Islands'), ('WS', 'Samoa'), ('YE', 'Yemen'), ('YU', 'Yugoslavia'),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(choices=[('y', 'Yes'), ('n', 'No'), ('r', 'Prefer not to tell')], default='',
                                   max_length=1, verbose_name='Are you a person with a disability?'),
        ),
        migrations.AlterField(
            model_name='userregistrationcourse',
            name='homeless',
            field=models.CharField(choices=[('y', 'Yes'), ('n', 'No'), ('r', 'Prefer not to tell')], default='',
                                   max_length=1, verbose_name='Are you homeless or excluded from housing?'),
        ),
        migrations.AlterField(
            model_name='userregistrationcourse',
            name='social_disadvantage',
            field=models.CharField(choices=[('y', 'Yes'), ('n', 'No'), ('r', 'Prefer not to tell')], default='',
                                   max_length=1, verbose_name='Are you a socially disadvantaged person?'),
        ),
    ]
